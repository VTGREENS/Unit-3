...
//   ? What if you want the first and last names of living presidents

let namedPresidents = livingPresidents.map((president)=> `${president.first} ${president.last}`)
...
deadPresidents.forEach((president) => {
    ...
    deathAge = (president.passed - president.year);
    console.log(`${president.first} ${president.last} was ${deathAge} when he died`);
...
deadPresidents.forEach((president) => {
    ...
    deathAge = (passed - year);
    console.log(`${first} ${last} was ${deathAge} when he died`);
